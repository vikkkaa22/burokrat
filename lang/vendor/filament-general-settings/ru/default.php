...
return [
    ...
    'site_favicon' => 'Favicon для сайта',
    'support_email' => 'Email',
    'support_phone' => 'Телефон',
    'theme_color' => 'Цветовая тема',
    'theme_color_helper_text' => 'Этот цвет будет использоваться как основной; для цвета по умолчанию оставьте поле пустым.',
