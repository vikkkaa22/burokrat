...
>
    <div class="max-w-[1440px] mx-auto px-[120px]">
        <!-- Верхняя часть -->
        <div class="grid grid-cols-[500px_1fr] gap-20 mb-20">
...
<div class="flex justify-center items-center gap-10 mt-12">
    ...
    <div
        ...
        style="display:none"
        class="fixed inset-0 bg-gray z-50 flex items-center justify-center p-10"
    >
        <div
...
function reviewsSlider() {
    return {
        ...
        reviews: [
            ...
            { id:'02', date:'06 Января 2025', image:'img/reviews02.jpg' },
            { id:'03', date:'02 Августа 2025', image:'img/reviews03.jpg' },
            { id:'04', date:'16 Августа 2025', image:'img/reviews04.jpg' },
            { id:'05', date:'13 Июня 2025', image:'img/reviews05.jpg' },
            { id:'06', date:'19 Июня 2025', image:'img/reviews06.jpg' },
            { id:'07', date:'19 Июня 2025', image:'img/reviews07.jpg' },
            { id:'08', date:'11 Января 2025', image:'img/reviews08.jpg' },
            { id:'09', date:'12 Июля 2025', image:'img/reviews09.jpg' },
            { id:'10', date:'26 Октября 2025', image:'img/reviews10.jpg' }
        ],
        get currentReview() {
