...
>
    <div class="max-w-[1440px] mx-auto px-[120px]">
       ...
       <div class="relative mb-8 lg:mb-10">
                    <div class="absolute top-0 left-0 text-[70px] md:text-[100px] xl:text-[128px] font-bold uppercase text-white font-main blur-[6px] opacity-30 pointer-events-none leading-none">
                        БЮРОКРАТЪ
                    </div>
                    <h2 class="relative z-10 text-[36px] md:text-[48px] xl:text-[64px] uppercase font-title font-bold text-white">
                        МУЗЕЙ
                    </h2>
                </div>
        <!-- Слайдер -->
...
function reviewsSlider() {
    return {
        ...
        current: 0,
        reviews: [
            { id:'ШКОЛЬНЫЙ КАБИНЕТ', image:'img/classroom.png' },
            { id:'ДЕТСКАЯ КОМНАТА',  image:'img/kids-room.png' },
            { id:'РАБОЧИЙ КАБИНЕТ',  image:'img/work-place.png' },
            { id:'ГОСТИНАЯ',  image:'img/living-room.png' },
        ],
        get currentReview() {
